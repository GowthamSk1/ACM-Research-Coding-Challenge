'''
1. Use Built-in K-means Clustering Algorithm (Sklearn)
2. Determine the number of clusters in a dataset
3. Calculate Optimal K value (Optional Clusters)
4. Plot Elbow Method and ClusterPlot.csv with clusters
...
plt.scatter(csv_data['V1'], csv_data['V2'], c= kmeans.labels_.astype(float), s=20, alpha=0.5)
plt.scatter(cent[:, 0], cent[:, 1], c='red', s=50)
plt.show()


# Sources cited in the README
